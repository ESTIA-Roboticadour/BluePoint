    ...
    m_ui(new Ui::CameraWindowClass())
{
    ...
    connect(m_ui->deviceSpinBox, &QSpinBox::valueChanged, this, &CameraWindow::deviceChanged);
}
...
void CameraWindow::onDeviceChanged(int device)
{
    m_ui->deviceSpinBox->setValue(device);
}
